...
export default function FAQ() {
  ...
  return (
    <>
      ...
      <header className="relative pt-28 md:pt-36 pb-12 md:pb-20 overflow-hidden bg-navy-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-left md:text-center">
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 border border-primary/30 rounded-full bg-white/5 backdrop-blur-md">
            <Icon icon="material-symbols:help-outline" className="text-primary" />
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <nav aria-label="Navegação de tópicos da FAQ" className="lg:hidden mb-8 overflow-hidden">
              ...
              <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide snap-x">
                <a href="#geral" className="snap-center shrink-0 flex items-center gap-2 px-4 py-3 rounded-lg bg-white border border-slate-200 text-navy-900 shadow-sm whitespace-nowrap">
                  <Icon icon="material-symbols:info" className="text-primary" /> Sobre
                </a>
                <a href="#venda" className="snap-center shrink-0 flex items-center gap-2 px-4 py-3 rounded-lg bg-white border border-slate-200 text-navy-900 shadow-sm whitespace-nowrap">
                  <span className="material-symbols-outlined text-primary">sell</span> Venda
                </a>
                <a href="#juridico" className="snap-center shrink-0 flex items-center gap-2 px-4 py-3 rounded-lg bg-white border border-slate-200 text-navy-900 shadow-sm whitespace-nowrap">
                  <span className="material-symbols-outlined text-primary">gavel</span> Jurídico
                </a>
                <a href="#pagamento" className="snap-center shrink-0 flex items-center gap-2 px-4 py-3 rounded-lg bg-white border border-slate-200 text-navy-900 shadow-sm whitespace-nowrap">
            ...
            <section id="geral" className="scroll-mt-20 md:scroll-mt-32">
              <div className="flex items-center gap-3 mb-6">
                <Icon icon="material-symbols:info" className="text-primary text-2xl sm:text-3xl" />
                <h2 className="text-navy-900 font-display text-2xl sm:text-3xl">Sobre Precatórios</h2>
              </div>
              <div className="space-y-4">
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none select-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4 text-left">O que é um Precatório?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
                ...
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none select-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4 text-left">Qual a diferença entre Precatório e RPV?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
                ...
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none select-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4 text-left">O que são Precatórios Federais, Estaduais e Municipais?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
            ...
            <section id="venda" className="scroll-mt-20 md:scroll-mt-32">
              <div className="flex items-center gap-3 mb-6">
                <Icon icon="material-symbols:sell" className="text-primary text-2xl sm:text-3xl" />
              ...
              <div className="space-y-4">
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">Como funciona a venda do meu precatório?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
                ...
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">O que é o deságio?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
                ...
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">Posso vender apenas uma parte do meu precatório?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
            ...
            <section id="juridico" className="scroll-mt-20 md:scroll-mt-32">
              <div className="flex items-center gap-3 mb-6">
                <Icon icon="material-symbols:gavel" className="text-primary text-2xl sm:text-3xl" />
                <h2 className="text-navy-900 font-display text-2xl sm:text-3xl">Segurança e Jurídico</h2>
              </div>
              <div className="space-y-4">
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">É legal vender meu precatório?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
                ...
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">Preciso da autorização do meu advogado para vender?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
                ...
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">Quais documentos são necessários?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
            ...
            <section id="pagamento" className="scroll-mt-20 md:scroll-mt-32">
              <div className="flex items-center gap-3 mb-6">
                <Icon icon="material-symbols:payments" className="text-primary text-2xl sm:text-3xl" />
                <h2 className="text-navy-900 font-display text-2xl sm:text-3xl">Pagamento e Prazos</h2>
              </div>
              <div className="space-y-4">
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">Quando recebo o dinheiro?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
                ...
                <details className="bg-white border border-slate-200 rounded-lg group transition-all duration-300 ease-in-out overflow-hidden hover:border-primary/50 group-open:border-primary/50 group-open:shadow-xl group-open:shadow-primary/10">
                  <summary className="flex justify-between items-center p-4 md:p-6 cursor-pointer list-none">
                    <h3 className="text-navy-900 font-display text-sm sm:text-base md:text-lg font-medium group-hover:text-primary group-open:text-primary transition-colors flex-1 pr-4">Tenho que pagar imposto sobre a venda?</h3>
                    <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                      <Icon icon="material-symbols:expand-more" className="text-slate-500 group-hover:text-primary group-open:text-primary transition-transform duration-300 group-open:rotate-180" />
                    </div>
                  </summary>
